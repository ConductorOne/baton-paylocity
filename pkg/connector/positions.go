...
func (o *PositionBuilder) List(ctx context.Context, parentResourceID *v2.ResourceId, opts rs.SyncOpAttrs) ([]*v2.Resource, *rs.SyncOpResults, error) {
	...
	if err != nil {
		return nil, syncResultOp, fmt.Errorf("listing position codes failed: %w", err)
	}
	...
	syncResultOp.NextPageToken = nextPage

	return resources, syncResultOp, nil
}

func (o *PositionBuilder) Entitlements(_ context.Context, resource *v2.Resource, _ rs.SyncOpAttrs) ([]*v2.Entitlement, *rs.SyncOpResults, error) {
...
func (o *PositionBuilder) Grants(_ context.Context, _ *v2.Resource, _ rs.SyncOpAttrs) ([]*v2.Grant, *rs.SyncOpResults, error) {
	return nil, nil, nil
}
...
func parsePositionToResource(position *client.Position, parentResourceID *v2.ResourceId) (*v2.Resource, error) {
	...
	positionTraitOptions := []rs.RoleTraitOption{
		rs.WithRoleProfile(profile),
	}

	positionResource, err := rs.NewRoleResource(
		position.Title,
